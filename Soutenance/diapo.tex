...
\newcommand{\mybullet}{\usebeamertemplate{itemize item}\hspace{0.5em}}
...
\title[Soutenance de Stage]{Ajustement de surfaces de potentiels}
...
\begin{frame}{Sujet du Stage}
  ...
  \begin{exampleblock}{Références}
    ...
    \item \textit{R.R. Toczyłowski, doctoral thesis, Miami University, 2004}
  \end{itemize} 
  \end{exampleblock}
  ...
  \begin{itemize}
    ...
    \item Déterminer comment évaluer la qualité du fit
...
\begin{frame}{Implémentation du modèle}
  \begin{block}{Etapes}
    \begin{itemize}
      \item Numérisation des tableaux de données ab-initio
...
\begin{frame}{Implémentation plus performante}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.48\textwidth}
      \begin{table}
        \caption{Temps d'exécution moyen par appel}\label{tab:temps}
        \begin{center}
          \begin{tabular}[c]{lcc}
            \hline
    ...
    \begin{column}{0.33\textwidth\small}
      \begin{exampleblock}{\texttt{least\_squares}}
        \begin{itemize}
          ...
          \item On choisit une fonction résidus
    ...
    \begin{column}{0.33\textwidth\small}
      \begin{block}{\texttt{differential\_evolution}}
       \begin{itemize}
          ...
          \item Echappe aux minima locaux
          \item Plus lente
...
\section{Ajustements de surface}

\begin{frame}{Premières données ab-initio - Surface n°1}
  \textit{Theoretical study of the He–HCN, Ne–HCN, Ar–HCN, and Kr–HCN complexes
  - 2000 - R.R. Toczyłowski, F. Doloresco, S.M. Cybulski}
  \begin{columns}[T]
    \begin{column}{0.45\textwidth}
      \begin{block}{}
        \begin{itemize}
    ...
    \begin{column}{0.45\textwidth}
       \begin{block}{}
        \begin{itemize}
          ...
          \item Première sélection graphique 
          \item Deuxième sélection à l'aide des métriques : R², RMSE, MAE 
        \end{itemize}
      \end{block}
    \end{column}
...
\begin{frame}{Contour plots des surfaces d'énergie potentielle pour Ar-HCN}
  \begin{columns}[T]
    ...
    \begin{column}{0.35\textwidth}
      \begin{figure}
        \caption{\scriptsize Plot de l'article}
        \begin{center}
...
\begin{frame}{Nouvelles données ab-initio pour Ar-HCN - Surface n°2}
...
\begin{frame}{Erreurs relatives à $\theta=90$° du fit de la surface n°2}
  \begin{figure}
    \caption{Erreurs relatives obtenues avec les paramètres optimisés par différentes méthodes}
    \begin{center}
      \includegraphics[width=0.50\textwidth]{../Figures/Soutenance/Ar-err-rel-T90-methodes.png}
    \end{center}
  \end{figure}
\end{frame}


\begin{frame}{Contours plot et erreurs relatives par rapport à la surface n°2}
  \begin{columns}[T]
    \begin{column}{0.35\textwidth}
        \begin{figure}
          \caption{\scriptsize Paramètres donnés par R. Toczyłowski}
          \begin{center}
    ...
    \begin{column}{0.35\textwidth}
      \begin{figure}
        \caption{\scriptsize Meilleurs paramètres calculés sur la Surface n°1}
        \begin{center}
    ...
    \begin{column}{0.35\textwidth}
      \begin{figure}
        \caption{\scriptsize Meilleurs paramètres calculés sur la Surface n°2}
        \begin{center}
  ...
  \begin{columns}[T]
    \begin{column}{0.50\textwidth\small}
      \begin{block}{Réseau n°1}
        \begin{itemize}
          \item batch\_size : $128$ | learning rate : $10^{-5}$
    ...
    \begin{column}{0.50\textwidth\small}
      \begin{block}{Réseau n°2}
        \begin{itemize}
          \item batch\_size : $256$ | learning rate : $10^{-4}$
...
\begin{frame}{Conclusion et Perspectives}
  \begin{block}{Bilan et Perspectives}
      \begin{itemize}
          \item \textbf{Robustesse :} Implémentation d'un modèle physique - production de nouveaux paramètres validés pour plusieurs systèmes
          ...
          \item \textbf{Perspectives :} Autres méthodes d'optimisation, Réseaux de neurones
      \end{itemize}
  \end{block}
